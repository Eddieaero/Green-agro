        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption top-0 bottom-0 start-0 end-0 d-flex flex-column align-items-center justify-content-center">
                        <div class="text-start p-5" style="max-width: 900px;">
                            <h3 class="text-white">Precise Agriculture</h3>
                            <h1 class="display-1 text-white mb-md-4">sustainable agriculture practices</h1>
                            <a href="login.php" class="btn btn-primary py-md-3 px-md-5 me-3">Explore</a>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption top-0 bottom-0 start-0 end-0 d-flex flex-column align-items-center justify-content-center">
                        <div class="text-start p-5" style="max-width: 900px;">
                            <h3 class="text-white">Zero carbon emission agriculture</h3>
                            <h1 class="display-1 text-white mb-md-4">Save the planet save your tomorrow</h1>
            ...
            <div class="row gx-0">
                <div class="col-md-6">
                    <div class="bg-primary bg-vegetable d-flex flex-column justify-content-center p-5" style="height: 300px;">
                        <h3 class="text-white mb-3">Carbon emissions</h3>
                        <p class="text-white">Agriculture is a significant contributor to carbon emissions, accounting for around 10% to 12% of global greenhouse gas emissions.</p>
                ...
                <div class="col-md-6">
                    <div class="bg-secondary bg-fruit d-flex flex-column justify-content-center p-5" style="height: 300px;">
                        <h3 class="text-white mb-3">Sustainable Agriculture</h3>
                        <p class="text-white">Sustainable agriculture practices can play an important role in reducing carbon emissions in the agricultural sector</p>
                        <a class="text-white fw-bold" href="">Read More<i class="bi bi-arrow-right ms-2"></i></a>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row gx-5">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <div class="d-flex h-90 border border-0 border-primary border-bottom-0 pt-4">
                        <img class="img-fluid mt-auto mx-auto" src="img/about.jpeg" style="height: 500px;">
                    </div>
                </div>
                
                <div class="col-lg-6 pb-5">
                    <div class="mb-3 pb-2">
                        <h6 class="text-primary text-uppercase"><br>
                            About Us</h6>
                        <h1 class="display-5">We Provide best practices towards zero carbon emission agriculture</h1>
                    </div>
                    <p class="mb-4">we provide best practices which help reduce the release of carbon emissions to the environment saving our planet and making it a safer place to live</p>
                    <div class="row gx-5 gy-4">
                        <div class="col-sm-6">
                            <i class="fa fa-seedling display-1 text-secondary"></i>
                            <h4>100% Organic</h4>
                            <p class="mb-0">our practices are 100% organic ensuring better yield and increase soil structure and fertility</p>
                        </div>
                        <div class="col-sm-6">
                            <i class="fa fa-award display-1 text-secondary"></i>
                            <h4>Proven</h4>
                            <p class="mb-0">our practices are proven and are backed by research from top agricultural experts</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    <div class="mb-3">
                        ...
                        <h1 class="display-5">Green Agro Services</h1>
                    </div>
                    <p class="mb-4">The following include services provided by Green Agro systems</p>
                    <a href="login.php" class="btn btn-primary py-md-3 px-md-5">Start A Project</a>
                </div>
                <div class="col-lg-4 col-md-6">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-item bg-light text-center p-5">
                        ...
                        <p class="mb-0">provision of education on how to better manage your cattle to ensure their health and continuous survival</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="service-item bg-light text-center p-5">
                        ...
                        <h4>Agroforestry</h4>
                        <p class="mb-0">how to ntegrate trees and other vegetation into agricultural landscapes to create sustainable and productive ecosystems</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="service-item bg-light text-center p-5">
                        ...
                        <h4>Farming Plans</h4>
                        <p class="mb-0">they take into account a variety of factors,including climate, soil conditions, available resources, and market demands</p>
                    </div>
                </div>
                <!--  -->
            </div>
            ...
            <div class="row g-5">
                <div class="col-lg-3">
                    <div class="text-white mb-5">
                        ...
                        <p class="mb-0">our services are 100% organic thus saving you and your environment</p>
                    </div>
                    <div class="text-white">
                        <div class="bg-secondary rounded-pill d-flex align-items-center justify-content-center mb-3" style="width: 60px; height: 60px;">
                            <i class="fa fa-award fs-4 text-white"></i>
                        </div>
                        <h4 class="text-white">Proven</h4>
                        <p class="mb-0">The services we offer are backed by agricultural expert's research</p>
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-3">
                    <div class="text-white mb-5">
                        ...
                        <p class="mb-0">our solutions go hand in hand with modern farming</p>
                    </div>
                    <div class="text-white">
                        <div class="bg-secondary rounded-pill d-flex align-items-center justify-content-center mb-3" style="width: 60px; height: 60px;">
                        ...
                        <p class="mb-0">we are available for support at any time</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row gx-5">
                    <div class="col-lg-4 col-md-12 pt-5 mb-5">
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <p class="text-white mb-0">COICT, UDSM</p>
                        </div>
                        <div class="d-flex mb-2">
                            <i class="bi bi-envelope-open text-white me-2"></i>
                            <p class="text-white mb-0">info@greeagro.com</p>
                        </div>
                        <div class="d-flex mb-2">
                            <i class="bi bi-telephone text-white me-2"></i>
                            <p class="text-white mb-0">+255 222 222</p>
                        </div>
